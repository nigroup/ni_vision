...
(cl:defclass <PolygonMesh> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (polygons
    :reader polygons
    :initarg :polygons
    :type (cl:vector pcl-msg:Vertices)
   :initform (cl:make-array 0 :element-type 'pcl-msg:Vertices :initial-element (cl:make-instance 'pcl-msg:Vertices))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <PolygonMesh>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PolygonMesh)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pcl-msg:<PolygonMesh> is deprecated: use pcl-msg:PolygonMesh instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <PolygonMesh>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl-msg:header-val is deprecated.  Use pcl-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'cloud-val :lambda-list '(m))
(cl:defmethod cloud-val ((m <PolygonMesh>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl-msg:cloud-val is deprecated.  Use pcl-msg:cloud instead.")
  (cloud m))

(cl:ensure-generic-function 'polygons-val :lambda-list '(m))
(cl:defmethod polygons-val ((m <PolygonMesh>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl-msg:polygons-val is deprecated.  Use pcl-msg:polygons instead.")
  (polygons m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <PolygonMesh>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'polygons)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'pcl-msg:Vertices))
