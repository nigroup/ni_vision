...
(cl:defmethod cl:initialize-instance :after ((m <PointIndices>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointIndices)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name pcl-msg:<PointIndices> is deprecated: use pcl-msg:PointIndices instead.")))
...
(cl:defmethod indices-val ((m <PointIndices>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pcl-msg:indices-val is deprecated.  Use pcl-msg:indices instead.")
  (indices m))
