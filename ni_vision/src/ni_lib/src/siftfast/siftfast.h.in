...
#define SIFTFAST_VERSION_MAJOR @SIFTFAST_VERSION_MAJOR@
#define SIFTFAST_VERSION_MINOR @SIFTFAST_VERSION_MINOR@
#define SIFTFAST_VERSION_PATCH @SIFTFAST_VERSION_PATCH@
